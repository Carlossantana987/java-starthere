...
public class BooksController {
    ...
    /* GET ENDPOINT*/ @GetMapping(value = "/books")
    ...
    /* UPDATE ENDPOINT */ @PutMapping(value = "/data/books/{id}")
    ...
    /* POST ENDPOINT */ @PostMapping(value = "/data/books/{id}")
    ...
    /* DELETE ENDPOINT */ @DeleteMapping(value = "/data/books/{id}")
